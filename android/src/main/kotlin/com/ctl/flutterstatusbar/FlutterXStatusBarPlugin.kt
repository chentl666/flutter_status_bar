package com.ctl.flutterstatusbar
...
class FlutterXStatusBarPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "com.ctl.plugins/flutterstatusbar")
